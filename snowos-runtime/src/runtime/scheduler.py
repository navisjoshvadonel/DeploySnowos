...
class RuntimeScheduler:
    ...
    def _run(self):
        while not self._stop_event.is_set():
            ...
            interval = 15
            if hasattr(self.nyx, "ui_state") and getattr(self.nyx, "ui_state") and hasattr(self.nyx.ui_state, "state") and getattr(self.nyx.ui_state, "state"):
                if self.nyx.ui_state.state.get("user_state") == "active":
                    interval = 5
